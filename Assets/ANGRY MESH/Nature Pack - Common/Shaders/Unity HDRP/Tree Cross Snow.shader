	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float mulTime10_g90 = _TimeParameters.x * AGW_WindSpeed;
				float temp_output_28_0_g90 = ( ( sin( ( ( ase_worldPos.z * AGW_WindScale ) + ( ( AGW_WindSpeed * sin( _TimeParameters.x * 0.5 ) ) + mulTime10_g90 ) ) ) * ( AGW_WindToggle * AGW_WindAmplitude * _WindAmplitude ) ) * inputMesh.ase_color.r );
				float3 appendResult63_g90 = (float3(temp_output_28_0_g90 , 0.0 , temp_output_28_0_g90));
				half3 Output_Wind548 = appendResult63_g90;
				
				float4 temp_cast_0 = (1.0).xxxx;
				float2 appendResult8_g89 = (float2(ase_worldPos.x , ase_worldPos.z));
				float4 lerpResult17_g89 = lerp( _TintColor1 , _TintColor2 , saturate( ( tex2Dlod( AG_TintNoiseTexture, float4( ( appendResult8_g89 * ( 0.001 * AG_TintNoiseTile * _TintNoiseTile ) ), 0, 0.0) ).r * (0.001 + (AG_TintNoiseContrast - 0.001) * (60.0 - 0.001) / (10.0 - 0.001)) ) ));
				float4 lerpResult19_g89 = lerp( temp_cast_0 , lerpResult17_g89 , AG_TintToggle);
				float4 vertexToFrag18_g89 = lerpResult19_g89;
				outputPackedVaryingsMeshToPS.ase_texcoord6 = vertexToFrag18_g89;
						...
						)
			{
				...
				float4 vertexToFrag18_g89 = packedInput.ase_texcoord6;
				half4 TintColor1115 = vertexToFrag18_g89;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float4 lerpResult19_g89 = lerp( temp_cast_0 , lerpResult17_g89 , AG_TintToggle);
				float4 vertexToFrag18_g89 = lerpResult19_g89;
				outputPackedVaryingsMeshToPS.ase_texcoord1 = vertexToFrag18_g89;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode162 = tex2D( _MainTex, uv_MainTex162 );
				float4 vertexToFrag18_g89 = packedInput.ase_texcoord1;
				half4 TintColor1115 = vertexToFrag18_g89;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float4 lerpResult19_g89 = lerp( temp_cast_0 , lerpResult17_g89 , AG_TintToggle);
				float4 vertexToFrag18_g89 = lerpResult19_g89;
				outputPackedVaryingsMeshToPS.ase_texcoord8 = vertexToFrag18_g89;
						...
						)
			{
				...
				float4 tex2DNode162 = tex2D( _MainTex, uv_MainTex162 );
				float4 vertexToFrag18_g89 = packedInput.ase_texcoord8;
				half4 TintColor1115 = vertexToFrag18_g89;
...
/*ASEBEGIN
Version=18801
1920;1;1906;1011;5099.143;2754.563;4.218896;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1147;-4352,384;Inherit;False;AG Global Tint Color;0;;89;1dcc860732522ee469468f952b4e8aa1;0;3;27;COLOR;0,0,0,0;False;28;COLOR;0,0,0,0;False;22;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;1143;-4096,-1152;Inherit;False;AG Global Snow - Tree;-1;;88;0af770cdce085fc40bbf5b8250612a37;0;4;22;FLOAT;0;False;24;FLOAT;0;False;23;FLOAT;0;False;25;FLOAT;0;False;2;FLOAT;0;FLOAT;33
...
Node;AmplifyShaderEditor.FunctionNode;1142;-4352,-256;Inherit;False;AG Global Wind - Tree Cross;-1;;90;113fb90e51be7cd4cb8fd0e2ac81b3e8;0;2;48;FLOAT;0;False;96;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.DiffusionProfileNode;1195;0,-768;Float;False;Constant;_DiffusionProfile;_DiffusionProfile;15;0;Create;True;0;0;0;False;0;False;e757c67f815166a46bf02923652e8e19;e757c67f815166a46bf02923652e8e19;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1107;0,-960;Half;False;Property;_Cutoff;Alpha Cutoff;2;1;[HideInInspector];Create;False;0;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1196;0,-864;Half;False;Property;_Thickness1;Translucency Thickness;14;0;Create;False;0;0;0;False;1;Header(Translucency);False;0.5;0.2;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E817C557152468F6FA5032AD12B78A49DE8C65DA