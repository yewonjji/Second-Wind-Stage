	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 appendResult8_g133 = (float2(ase_worldPos.x , ase_worldPos.z));
				float4 lerpResult17_g133 = lerp( _TintColor1 , _TintColor2 , saturate( ( tex2Dlod( AG_TintNoiseTexture, float4( ( appendResult8_g133 * ( 0.001 * AG_TintNoiseTile * _TintNoiseTile ) ), 0, 0.0) ).r * (0.001 + (AG_TintNoiseContrast - 0.001) * (60.0 - 0.001) / (10.0 - 0.001)) ) ));
				float4 lerpResult19_g133 = lerp( temp_cast_2 , lerpResult17_g133 , AG_TintToggle);
				float4 vertexToFrag18_g133 = lerpResult19_g133;
				outputPackedVaryingsMeshToPS.ase_texcoord6 = vertexToFrag18_g133;
						...
						)
			{
				...
				float4 vertexToFrag18_g133 = packedInput.ase_texcoord6;
				half4 TintColor1462 = vertexToFrag18_g133;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float4 lerpResult19_g133 = lerp( temp_cast_2 , lerpResult17_g133 , AG_TintToggle);
				float4 vertexToFrag18_g133 = lerpResult19_g133;
				outputPackedVaryingsMeshToPS.ase_texcoord1 = vertexToFrag18_g133;
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode162 = tex2D( _MainTex, uv_MainTex162 );
				float4 vertexToFrag18_g133 = packedInput.ase_texcoord1;
				half4 TintColor1462 = vertexToFrag18_g133;
				float4 temp_output_163_0 = ( _Color * tex2DNode162 * TintColor1462 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float4 lerpResult19_g133 = lerp( temp_cast_2 , lerpResult17_g133 , AG_TintToggle);
				float4 vertexToFrag18_g133 = lerpResult19_g133;
				outputPackedVaryingsMeshToPS.ase_texcoord8 = vertexToFrag18_g133;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * unity_WorldTransformParams.w;
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
						...
						)
			{
				...
				float4 tex2DNode162 = tex2D( _MainTex, uv_MainTex162 );
				float4 vertexToFrag18_g133 = packedInput.ase_texcoord8;
				half4 TintColor1462 = vertexToFrag18_g133;
				float4 temp_output_163_0 = ( _Color * tex2DNode162 * TintColor1462 );
...
/*ASEBEGIN
Version=18801
1920;1;1906;1011;9711.922;3667.109;6.64255;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;1484;-4608,1248;Half;False;Property;_WindTrunkStiffness;Wind Trunk Stiffness;25;0;Create;True;0;0;0;False;0;False;3;2;1;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;364;-4480,-640;Float;False;Property;_EnableWorldProjection;Enable World Projection;31;0;Create;True;0;0;0;False;1;Header(Projection);False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1442;-3200,1632;Half;False;Property;_WindLeafStiffness;Wind Leaf Stiffness;29;0;Create;True;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1391;-3200,1344;Half;False;Property;_WindLeafAmplitude;Wind Leaf Amplitude;26;0;Create;True;0;0;0;False;1;Header(Wind Leaf);False;1;1;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1789;-3840,-480;Inherit;False;AG Global Snow - Height;-1;;132;792d553d9b3743f498843a42559debdb;0;0;1;FLOAT;43
...
Node;AmplifyShaderEditor.RangedFloatNode;1485;-4608,1344;Half;False;Property;_WindTrunkAmplitude;Wind Trunk Amplitude;24;0;Create;True;0;0;0;False;1;Header(Wind Trunk (use common settings for both materials));False;1;1;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1660;-4864,128;Inherit;False;AG Global Tint Color;0;;133;1dcc860732522ee469468f952b4e8aa1;0;3;27;COLOR;0,0,0,0;False;28;COLOR;0,0,0,0;False;22;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1390;-3200,1536;Half;False;Property;_WindLeafSpeed;Wind Leaf Speed;27;0;Create;True;0;0;0;False;0;False;2;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1389;-3200,1440;Half;False;Property;_WindLeafScale;Wind Leaf Scale;28;0;Create;True;0;0;0;False;0;False;15;2;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;1374;-1536,1280;Half;False;Global;AGW_WindDirection;AGW_WindDirection;20;0;Create;True;0;0;0;False;0;False;0,0,0;-0.4521585,-0.3420203,0.8237566;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;1791;0,-1600;Half;False;Property;_Thickness;Translucency Thickness;23;0;Create;False;0;0;0;False;1;Header(Translucency);False;0.5;0.2;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6E04BFC1FFC6E61B48246201B2A8DB1289CE13C5